...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-2ade9d35.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-2ade9d35.js", assets + "/_app/chunks/vendor-d84547fc.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-4313603e.js", "css": ["assets/pages/__layout.svelte-692b9a47.css", "assets/helperFunctions-49a62b4e.css"], "js": ["pages/__layout.svelte-4313603e.js", "chunks/vendor-d84547fc.js", "chunks/helperFunctions-e3f0e30b.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-6d82fd63.js", "css": [], "js": ["error.svelte-6d82fd63.js", "chunks/vendor-d84547fc.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-0898146d.js", "css": ["assets/pages/index.svelte-42f12ad4.css", "assets/helperFunctions-49a62b4e.css"], "js": ["pages/index.svelte-0898146d.js", "chunks/vendor-d84547fc.js", "chunks/helperFunctions-e3f0e30b.js"], "styles": [] }, "src/routes/portfolio.svelte": { "entry": "pages/portfolio.svelte-43b9cc94.js", "css": [], "js": ["pages/portfolio.svelte-43b9cc94.js", "chunks/vendor-d84547fc.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-12e6f102.js", "css": [], "js": ["pages/about.svelte-12e6f102.js", "chunks/vendor-d84547fc.js"], "styles": [] } };
...
var Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${type === "anchor" ? `<a${add_attribute("href", link, 0)} class="${escape(null_to_empty(btnClass)) + " svelte-63hkw5"}">${escape(content)}</a>` : `<button type="${"button"}" class="${escape(null_to_empty(btnClass)) + " svelte-63hkw5"}">${escape(content)}</button>`}`;
});
var css$e = {
...
var Heading$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { type = h2, content = "", content2 = "", headingClass = "" } = $$props;
  if ($$props.type === void 0 && $$bindings.type && type !== void 0)
    $$bindings.type(type);
  if ($$props.content === void 0 && $$bindings.content && content !== void 0)
    $$bindings.content(content);
...
var HeroText = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"hero-text-container svelte-14kq9f0"}">${validate_component(Heading$1, "Heading").$$render($$result, {
    content: "No-nonsense",
...
<div class="${"lines-container svelte-mhujaj"}"><div class="${"section first-section svelte-mhujaj"}" style="${"height: " + escape(headerHeight) + "px;"}">${validate_component(Line, "Line").$$render($$result, {
    ...
    left: "5%"
		...
		<span class="${"circle svelte-mhujaj"}"></span></div>
	<div class="${"section first-section svelte-mhujaj"}" style="${"height: " + escape(heroHeight) + "px; margin-bottom: " + escape(sectionGap) + ";"}"></div>
	<div class="${"section first-section svelte-mhujaj"}" style="${"height: " + escape(philosophyHeight) + "px; margin-bottom: " + escape(sectionGap) + ";"}">${validate_component(Line, "Line").$$render($$result, {
    direction: "horizontal",
    dimension: "70vw",
    left: "0%",
    bottom: "-20%"
  }, {}, {})}</div>
	<div class="${"section first-section svelte-mhujaj"}" style="${"height: " + escape(technologiesHeight) + "px; margin-bottom: " + escape(sectionGap) + ";"}">${validate_component(Line, "Line").$$render($$result, {
    direction: "horizontal",
    dimension: "70vw",
    right: "0%",
    bottom: "-20%"
...
var Philosophy = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Section, "Section").$$render($$result, { sectionClass: "philosophy span-1220" }, {}, {
    default: () => `<div class="${"flex-container svelte-79ep15"}">${validate_component(Heading$1, "Heading").$$render($$result, { content: "my philosophy", type: "2" }, {}, {})}
...
var PortfolioFilter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"filters-container svelte-xn6cqg"}">${each(options2, ({ name, text }) => `<label${add_attribute("for", name, 0)} class="${["svelte-xn6cqg", selectedFilter === name ? "active" : ""].join(" ").trim()}"><input type="${"radio"}"${add_attribute("id", name, 0)}${add_attribute("name", name, 0)}${add_attribute("value", name, 0)} class="${"hidden svelte-xn6cqg"}"${name === selectedFilter ? add_attribute("checked", true, 1) : ""}>
			<div class="${"label-content svelte-xn6cqg"}"><div class="${"radio-button svelte-xn6cqg"}"></div>
				<p class="${"radio-description svelte-xn6cqg"}">${escape(text)}</p></div>
		</label>`)}
</div>`;
});
var css$1 = {
  code: ".view-project-button svg path{fill:var(--clr-text-accent-cyan)}.view-project-button svg{transform:translateY(-0.1rem)}.text-container.svelte-rrbltf.svelte-rrbltf{display:flex;flex-flow:column nowrap;justify-content:start;align-items:start;gap:1.4rem;font-family:var(--fira)}.text-container.svelte-rrbltf h3.project-name.svelte-rrbltf{color:var(--clr-text-focused);font-size:clamp(2.2rem, 1.85636rem + 0.91638vw, 3rem)}.text-container.svelte-rrbltf p.subtitle.svelte-rrbltf{color:var(--clr-text-faded);font-size:clamp(1.4rem, 1.31409rem + 0.2291vw, 1.6rem)}.text-container.svelte-rrbltf p.description.svelte-rrbltf{color:var(--clr-text-focused);font-size:clamp(1.4rem, 1.31409rem + 0.2291vw, 1.6rem)}.text-container.svelte-rrbltf a.view-project-button.svelte-rrbltf{display:flex;flex-flow:row nowrap;justify-content:start;align-items:center;gap:0.95rem;color:var(--clr-text-accent-cyan);transition:transform 250ms}.text-container.svelte-rrbltf a.view-project-button.svelte-rrbltf:hover{transform:scale(1.1, 1.1) translate(0.6rem, 0)}.text-container.svelte-rrbltf a.view-project-button p.svelte-rrbltf{font-size:clamp(1.4rem, 1.31409rem + 0.2291vw, 1.6rem)}",
  map: `{"version":3,"file":"PortfolioText.svelte","sources":["PortfolioText.svelte"],"sourcesContent":["<script>\\r\\n    import {capitaliseFirstLetter} from '$lib/scripts/helperFunctions'\\r\\n    export let project\\r\\n    import Icon from '$lib/Decorations/Icon.svelte'\\r\\n\\r\\n    $: name = project.name\\r\\n    $: subtitle = project.subtitle\\r\\n    $: description = project.description\\r\\n<\/script>\\r\\n\\r\\n    <div class=\\"text-container\\">\\r\\n        <h3 class=\\"project-name\\">{capitaliseFirstLetter(name)}</h3>\\r\\n        <p class=\\"subtitle\\">{subtitle}</p>\\r\\n        <p class=\\"description\\">{description[0]}</p>\\r\\n        <a href=\\"/\\" class=\\"view-project-button\\">\\r\\n            <p>VIEW PROJECT </p>\\r\\n            <Icon name=\\"arrow-right\\" width=\\"1.4rem\\" />\\r\\n        </a>\\r\\n    </div>\\r\\n\\r\\n<style lang=\\"scss\\">:global(.view-project-button svg path) {\\n  fill: var(--clr-text-accent-cyan); }\\n\\n:global(.view-project-button svg) {\\n  transform: translateY(-0.1rem); }\\n\\n.text-container {\\n  display: flex;\\n  flex-flow: column nowrap;\\n  justify-content: start;\\n  align-items: start;\\n  gap: 1.4rem;\\n  font-family: var(--fira); }\\n  .text-container h3.project-name {\\n    color: var(--clr-text-focused);\\n    font-size: clamp(2.2rem, 1.85636rem + 0.91638vw, 3rem); }\\n  .text-container p.subtitle {\\n    color: var(--clr-text-faded);\\n    font-size: clamp(1.4rem, 1.31409rem + 0.2291vw, 1.6rem); }\\n  .text-container p.description {\\n    color: var(--clr-text-focused);\\n    font-size: clamp(1.4rem, 1.31409rem + 0.2291vw, 1.6rem); }\\n  .text-container a.view-project-button {\\n    display: flex;\\n    flex-flow: row nowrap;\\n    justify-content: start;\\n    align-items: center;\\n    gap: 0.95rem;\\n    color: var(--clr-text-accent-cyan);\\n    transition: transform 250ms; }\\n    .text-container a.view-project-button:hover {\\n      transform: scale(1.1, 1.1) translate(0.6rem, 0); }\\n    .text-container a.view-project-button p {\\n      font-size: clamp(1.4rem, 1.31409rem + 0.2291vw, 1.6rem); }\\n</style>\\r\\n"],"names":[],"mappings":"AAoB2B,6BAA6B,AAAE,CAAC,AACzD,IAAI,CAAE,IAAI,sBAAsB,CAAC,AAAE,CAAC,AAE9B,wBAAwB,AAAE,CAAC,AACjC,SAAS,CAAE,WAAW,OAAO,CAAC,AAAE,CAAC,AAEnC,eAAe,4BAAC,CAAC,AACf,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,MAAM,CAAC,MAAM,CACxB,eAAe,CAAE,KAAK,CACtB,WAAW,CAAE,KAAK,CAClB,GAAG,CAAE,MAAM,CACX,WAAW,CAAE,IAAI,MAAM,CAAC,AAAE,CAAC,AAC3B,6BAAe,CAAC,EAAE,aAAa,cAAC,CAAC,AAC/B,KAAK,CAAE,IAAI,kBAAkB,CAAC,CAC9B,SAAS,CAAE,MAAM,MAAM,CAAC,CAAC,UAAU,CAAC,CAAC,CAAC,SAAS,CAAC,CAAC,IAAI,CAAC,AAAE,CAAC,AAC3D,6BAAe,CAAC,CAAC,SAAS,cAAC,CAAC,AAC1B,KAAK,CAAE,IAAI,gBAAgB,CAAC,CAC5B,SAAS,CAAE,MAAM,MAAM,CAAC,CAAC,UAAU,CAAC,CAAC,CAAC,QAAQ,CAAC,CAAC,MAAM,CAAC,AAAE,CAAC,AAC5D,6BAAe,CAAC,CAAC,YAAY,cAAC,CAAC,AAC7B,KAAK,CAAE,IAAI,kBAAkB,CAAC,CAC9B,SAAS,CAAE,MAAM,MAAM,CAAC,CAAC,UAAU,CAAC,CAAC,CAAC,QAAQ,CAAC,CAAC,MAAM,CAAC,AAAE,CAAC,AAC5D,6BAAe,CAAC,CAAC,oBAAoB,cAAC,CAAC,AACrC,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,GAAG,CAAC,MAAM,CACrB,eAAe,CAAE,KAAK,CACtB,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,OAAO,CACZ,KAAK,CAAE,IAAI,sBAAsB,CAAC,CAClC,UAAU,CAAE,SAAS,CAAC,KAAK,AAAE,CAAC,AAC9B,6BAAe,CAAC,CAAC,kCAAoB,MAAM,AAAC,CAAC,AAC3C,SAAS,CAAE,MAAM,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,UAAU,MAAM,CAAC,CAAC,CAAC,CAAC,AAAE,CAAC,AACpD,6BAAe,CAAC,CAAC,oBAAoB,CAAC,CAAC,cAAC,CAAC,AACvC,SAAS,CAAE,MAAM,MAAM,CAAC,CAAC,UAAU,CAAC,CAAC,CAAC,QAAQ,CAAC,CAAC,MAAM,CAAC,AAAE,CAAC"}`
};
var PortfolioText = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  subtitle = project.subtitle;
  description = project.description;
  return `<div class="${"text-container svelte-rrbltf"}"><h3 class="${"project-name svelte-rrbltf"}">${escape(capitaliseFirstLetter(name))}</h3>
        <p class="${"subtitle svelte-rrbltf"}">${escape(subtitle)}</p>
        <p class="${"description svelte-rrbltf"}">${escape(description[0])}</p>
        <a href="${"/"}" class="${"view-project-button svelte-rrbltf"}"><p class="${"svelte-rrbltf"}">VIEW PROJECT </p>
...
var Portfolio$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Section, "Section").$$render($$result, { sectionClass: "span-1220" }, {}, {
    default: () => `<div class="${"flex-container svelte-9vu6xq"}">${validate_component(Heading$1, "Heading").$$render($$result, { type: "2", content: "portfolio" }, {}, {})}
		${validate_component(PortfolioFilter, "PortfolioFilter").$$render($$result, { initialFilter: filter }, {}, {})}
		${each(localPortfolio, (project, i) => `${validate_component(PortfolioText, "PortfolioText").$$render($$result, { project }, {}, {})}
			${validate_component(PortfolioVideo, "PortfolioVideo").$$render($$result, {}, {}, {})}`)}</div>`
  })}`;
});
